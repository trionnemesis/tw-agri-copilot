...
.taiwan-map [data-county-path]{pointer-events:bounding-box;fill:#eaf1ff;stroke:#2d6cdf;stroke-width:1.5;vector-effect:non-scaling-stroke;transition:fill .16s ease,stroke-width .16s ease,filter .16s ease}
