...
version: 1.1.0
status: Public prototype with county season map released and verified; Issue #44 Part B multi-category season semantics shipped with livestock/aquaculture mapped as explicit unknown
...
14. publishes a config-driven produce-category registry so the county season map carries per-category source status and states explicitly that livestock and aquaculture have no official production-season registry (unknown), without adding them to the market watchlist or the Buy Score gate.
